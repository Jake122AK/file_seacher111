...
const SECTIONS = [
  ...
  { name: 'VERSE 1',    bar: 8,   energy: .28, pattern: 'basic',     style: 'straight', amp: .34 },
  { name: 'VERSE 2',    bar: 16,  energy: .38, pattern: 'basic',     style: 'straight', amp: .44 },
  { name: 'WRONG 1',    bar: 22,  energy: .44, pattern: 'skankA',    style: 'sway',     amp: .52 },
  { name: 'WRONG 2',    bar: 32,  energy: .50, pattern: 'skankA',    style: 'skank',    amp: .58 },
  { name: 'TRIP 1',     bar: 42,  energy: .58, pattern: 'dub',       style: 'sway',     amp: .62, dub: 1 },
  { name: 'TRIP 2',     bar: 52,  energy: .64, pattern: 'dub',       style: 'long',     amp: .70, dub: 1 },
  { name: 'BUILD',      bar: 62,  energy: .78, pattern: 'build',     style: 'wave',     amp: .76 },
  { name: 'TUNNEL',     bar: 72,  energy: .12, pattern: 'tunnel',    style: 'still',    amp: .10 },
  { name: 'PARADISE',   bar: 76,  energy: .92, pattern: 'tropicalA', style: 'skank',    amp: .82 },
  { name: 'PARADISE 2', bar: 88,  energy: .88, pattern: 'tropicalA', style: 'wave',     amp: .82 },
  { name: 'PARADISE 3', bar: 100, energy: .94, pattern: 'tropicalB', style: 'sway',     amp: .86 },
  { name: 'COSMOS',     bar: 106, energy: .80, pattern: 'dub',       style: 'long',     amp: .82, dub: 1 },
  { name: 'MEGACITY',   bar: 118, energy: .86, pattern: 'cityA',     style: 'scratch',  amp: .86 },
  { name: 'JUNGLE',     bar: 128, energy: .82, pattern: 'jungleA',   style: 'wave',     amp: .84 },
  { name: 'ABYSS',      bar: 138, energy: .74, pattern: 'dubDeep',   style: 'long',     amp: .82, dub: 1 },
  { name: 'PSYCHE 1',   bar: 148, energy: .92, pattern: 'psychA',    style: 'wild',     amp: .90 },
  { name: 'PSYCHE 2',   bar: 160, energy: .96, pattern: 'psychA',    style: 'scratch',  amp: .94 },
  { name: 'PSYCHE 3',   bar: 172, energy: 1.0, pattern: 'psychB',    style: 'wave',     amp: .98 },
  { name: 'ASCEND',     bar: 182, energy: 1.0, pattern: 'build',     style: 'climax',   amp: 1.0 },
  { name: 'CLIMAX',     bar: 190, energy: 1.0, pattern: 'climaxA',   style: 'climax',   amp: 1.0 },
  { name: 'COMEDOWN',   bar: 202, energy: .22, pattern: 'outro',     style: 'still',    amp: .16 },
  { name: 'SILENCE',    bar: 208, energy: 0,   pattern: 'silence',   style: 'still',    amp: .05, bars: 6 }
];
